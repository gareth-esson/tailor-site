# Okay to Ask — Reel Scripts (Test Run)

Spoken voiceover drafts for vertical video. The post-it on screen shows the
question; the script is what the voice reads aloud. Source material: each
question's Full Answer (page body) plus its Simple Answer property. British
spelling, written for the ear, no spoken call to action.

Read-only test run — nothing written back to Notion.

| # | Mode | Question | Notion Category | Status |
|---|------|----------|-----------------|--------|
| 1 | Reflective / advice | Is it alright for your boyfriend to cheat on you and then want you back? | Relationships | Published |
| 2 | Reflective / advice | In a long relationship how long should it be before you have sex? | Relationships | Published |
| 3 | Factual / clinical | How are you tested for STIs? | Sexual Health | Published |
| 4 | Identity *(slot pending)* | Do gay men get more STDs than straight men? | Sexual Health | Published |
| 5 | Safeguarding-heavy | What are the main signs of an abusive relationship? | Relationships | Published |
| 6 | Wildcard (hard to compress) | If I played with myself, am I a virgin? | Sex | Published |

> **Note on slot 4:** No Published question carries the `Identity & Diversity`
> *Category*. In this workspace identity content sits in the **Topic** taxonomy
> while the question's Category is its clinical/relational bucket (confirmed in
> `src/pages/questions/index.astro` and `src/lib/site.ts`). The script below is
> a provisional fill using the strongest identity-*themed* Published question.
> Swap on your say-so.

---

## 1. Is it alright for your boyfriend to cheat on you and then want you back?
...
## 2. In a long relationship how long should it be before you have sex?
...
## 4. Do gay men get more STDs than straight men?  *(provisional — identity slot pending your pick)*
...
## 5. What are the main signs of an abusive relationship?
...
## 6. If I played with myself, am I a virgin?
