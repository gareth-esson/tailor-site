...
Second, that the people with power in a room are the ones who set the consent culture, not the ones most affected by it. That was true at RADA and it's true in schools. When [the adults in charge](/topics/healthy-vs-unhealthy-relationships) model checking in, naming limits, and respecting a no, the whole room shifts. When they don't, all the policy in the world won't save it.
