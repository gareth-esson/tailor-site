...
| Cross-cutting service/audience pages | **"RSE Delivery" becomes a top-level nav item** with a dropdown containing: RSE for primary schools, RSE for secondary schools, RSE for SEND & alternative provision (Circuits), and direct delivery. **"RSE Training" stays at `/rse-training`** as an existing top-level nav item. **"RSE policy and curriculum planning"** sits under RSE policy & curriculum planning on the Services page. |
